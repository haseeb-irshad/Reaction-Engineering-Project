...
class ToyCase(Benchmark):
    ...
    def _setup_kinetics_params(self):
        kinetics_params = {
            ("Activation_Energy", None, 0, 0, None): 80.0,  # kJ/mol
            ("Referenced_Reaction_Rate_Constant", None, 0, 0, None): 0.0001,  # L/mol s
    ...
    def _setup_operation_params(self):
        operation_params = {
            ("Concentration", None, 0, None, 0): None,  # mol/L
    ...
    def _setup_measure_ind2name(self):
        measure_ind2name = {
            ("Concentration", None, 0, None, 1): "outlet_B_conc",
        }
    ...
    def _simulate(self, params):
        ...
        def _derivative(t, c):
            ...
            r_r[0, 0] = A[0, 0] * np.exp(-E_a[0, 0] / R * (1 / T - 1 / 293.15)) * np.prod(c[0] ** n[0])
    ...
    def plot_product_profile_with_temperatures(self, operation_params, kinetics_params=None, transport_params=None):
        ...
        A_conc = operation_params[("Concentration", None, 0, None, 0)]
        ...
        for temperature in temperatures:
            _operation_params = {
                ...
                ("Concentration", None, 0, None, 0): A_conc,
            }
    ...
    def plot_product_profile_with_A_concs(self, operation_params, kinetics_params=None, transport_params=None):
        temperature = operation_params[("Temperature", None, None, None, None)]
        batch_time = operation_params[("Batch_Time", None, None, None, None)]
        A_concs = operation_params[("Concentration", None, 0, None, 0)]
